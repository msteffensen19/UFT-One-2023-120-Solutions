/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘AppC_FlightsService.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.FlightCities!Sheet1.Departure City}</DepartureCity><ArrivalCity>{DataSource.FlightCities!Sheet1.Arrival City}</ArrivalCity><FlightDate>2024-10-29T00:00:00+00:00</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi19 = new VTDPropertyInfoBase("Departure City");
            ...
            binding_setter10 = new StringFormaterDecorator(binding_setter10,"{DataSource.FlightCities!Sheet1.Departure City}");
            ...
            VTDPropertyInfoBase pi21 = new VTDPropertyInfoBase("Arrival City");
            ...
            binding_setter11 = new StringFormaterDecorator(binding_setter11,"{DataSource.FlightCities!Sheet1.Arrival City}");
            bind_dir11 = new BindDirection(this.DataCursorActivity12,binding_getter11,binding_setter11,BindTargetType.ToInProperty);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>John Jackson</CustomerName><DepartureDate>2024-10-29T00:00:00+00:00</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity5.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>2</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            bind_dir12 = new BindDirection(_flow.StServiceCallActivity5,binding_getter12,binding_setter12,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity6.InDirections.Add(bind_dir12);
